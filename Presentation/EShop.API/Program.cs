...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
	.AddJwtBearer(op =>
	{
		op.TokenValidationParameters = new TokenValidationParameters()
		{
			...
			IssuerSigningKey = new SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes("hfghfghfhfghtrongfhgfh fhdofvihdfoivhdoivhdofisvhosihvoidhvodsihvosisydtucgsdihcsdhviu dsivuhsdivuhsiuvhi")),
